...
export const metadata: Metadata = {
  title: "人物库",
  description: "沉淀一级市场科技领域创始人、科学家、工程负责人和关键决策者的长期人物档案，并连接公司与技术证据。",
};

const DIRECTORY_TAG_LIMIT = 1;
const DIRECTORY_SUMMARY_LIMIT = 24;
const DIRECTORY_EVENT_LIMIT = 24;
  ...
  return (
    <main className="page-shell subpage">
      <header className={`page-header ${styles.channelHeader}`}>
        <p className="eyebrow">04 / PEOPLE LIBRARY</p>
        <h1>人物库</h1>
        <div className="hero-chips">
          <span>{trackedCount} 位重点跟踪</span>
          {watchCount > 0 ? <span>{watchCount} 位观察对象</span> : null}
          <span>资料更新 {peopleGeneratedAt.slice(0, 10)}</span>
          <span>人物事件新闻统一进入首页“人物”频道</span>
        </div>
      </header>

      <ChannelSplitLayout
        channel="people"
        eyebrow="PEOPLE INTELLIGENCE LIBRARY"
        title="人物档案"
        description="这里保留人物长期研究资产：身份、角色、技术主线、观点演进、组织关系和可追溯证据；人物事件新闻统一由首页“人物”信息流承载。"
      ...
      <details className={styles.methodology}>
        ...
        <p>
          人物库解释关键人物的技术判断、组织选择和路线演进：沉淀为什么值得跟踪、技术主线、观点演进、任职关系与证据。
          高频人物事件和新闻不在这里重复维护，统一进入首页“人物”频道，并可从事件回链到对应人物档案。
        </p>
      </details>
    </main>
  );
