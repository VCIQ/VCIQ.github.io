    ...
    <main className="page-shell subpage">
      <header className="page-header">
        ...
        <div className={styles.analysisPolicy}>
          ...
          <span>{semanticRescued} 条弱证据由当前赛道语义锚点有限救援</span>
          <span>{analysis.population.sourceTrackSevereDownweighted} 条稳定高噪来源—赛道弱证据再乘 0.5</span>
          <span>{analysis.population.sourceTrackModerateDownweighted} 条稳定混合精度来源—赛道弱证据再乘 0.75</span>
          <span>{analysis.population.sourceTrackProvisional} 条来源—赛道仍在跨日观测期，暂不追加处罚</span>
          <span>
